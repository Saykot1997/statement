...
import AddTransactionUCO from '../../Components/AddTransactionUCO';
...
function UCOBankTran() {
    ...
    return (
        <div className='w-full h-[calc(100vh-64px)] bg-gray-100 overflow-y-scroll p-5'>
                            ...
                            <div className=' bg-white px-5 py-3 rounded shadow flex justify-between' key={transaction._id}>
                                {
                                    updateModeOpen && currentTransactionId === transaction._id ?
                                        ...
                                        :
                                        <div>
                                            <p className=' mb-2 text-sm'> <span className=' font-medium'>Particular : </span>{transaction.transactionName}</p>
                                            ...
                                            <p className=' mb-2 text-sm'> <span className=' font-medium'>Cheque Number : </span>{transaction.cheque}</p>
                                        </div>
                                }
                                {
                                    updateModeOpen && currentTransactionId === transaction._id ?
            ...
            {
                addTransactionMode &&
                <AddTransactionUCO toggleAddTransactionMode={toggleAddTransactionMode} />
            }
