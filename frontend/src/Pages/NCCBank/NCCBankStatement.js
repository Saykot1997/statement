            ...
            <table className=' w-full mt-10 print:mt-5'>
                <tbody>
                    <tr className=" border border-dashed">
                        <td className=" font-medium print:font-normal print:text-[10px] pb-1 text-left">Date</td>
                        <td className=" font-medium print:font-normal print:text-[10px] pb-1 text-left">Value Date</td>
                        <td className=" font-medium print:font-normal print:text-[10px] pb-1 text-left w-[27%]">Particular</td>
                        <td className=" font-medium print:font-normal print:text-[10px] pb-1 text-right">Withdrawal(Dr)</td>
                        <td className=" font-medium print:font-normal print:text-[10px] pb-1 text-right">Deposit(Cr)</td>
                        <td className=" font-medium print:font-normal print:text-[10px] pb-1 text-right">Balance</td>
                        <td className=" font-medium print:font-normal print:text-[10px] pb-1 text-right">Branch</td>
                        <td className=" font-medium print:font-normal print:text-[10px] pb-1 text-right">Time</td>
                    </tr>
                    <tr className="">
...
export default NCCBankStatement