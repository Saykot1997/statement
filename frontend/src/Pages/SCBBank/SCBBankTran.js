...
import AddTransactionSCB from '../../Components/AddTransactionSCB';
...
function SCBBankTran() {
    ...
    return (
        <div className='w-full h-[calc(100vh-64px)] bg-gray-100 overflow-y-scroll p-5'>
            ...
            {
                addTransactionMode &&
                <AddTransactionSCB toggleAddTransactionMode={toggleAddTransactionMode} />
            }
