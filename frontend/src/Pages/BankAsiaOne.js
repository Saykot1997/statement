        ...
        <div className=' w-full min-h-screen p-5'>
            <div className=' w-full border-t border-gray-800'>
                ...
                <div className=' w-full'>
                    ...
                    <div className=' w-full flex justify-between px-1 pb-10 print:pb-5 border-x border-gray-800 print:text-[12px] print:leading-[18px]'>
                        <div className=' w-1/2'>
                            <div className=' my-1'>
                ...
                <div className=' w-full mt-10 print:break-after-page'>
