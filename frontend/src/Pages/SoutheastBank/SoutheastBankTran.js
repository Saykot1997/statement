...
import AddTransactionSoutheast from '../../Components/AddTransactionSoutheast';
...
function SoutheastBankTran() {
    ...
    return (
        <div className='w-full h-[calc(100vh-64px)] bg-gray-100 overflow-y-scroll p-5'>
                            ...
                            <div className=' bg-white px-5 py-3 rounded shadow flex justify-between' key={transaction._id}>
                                {
                                    updateModeOpen && currentTransactionId === transaction._id ?
                                        ...
                                        <div>
                                            ...
                                            <p className=' mt-2 text-sm'> <span className=' font-medium'>Cheque No :</span> {transaction.cheque}</p>
            ...
            {
                addTransactionMode &&
                <AddTransactionSoutheast toggleAddTransactionMode={toggleAddTransactionMode} />
            }
...
export default SoutheastBankTran