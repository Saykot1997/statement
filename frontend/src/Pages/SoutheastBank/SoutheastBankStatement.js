...
function SoutheastBankStatement() {
    ...
    const [statementValidDate, setStatementValidDate] = useState("");
    ...
    return (
        <div className=' w-full min-h-screen p-10 print:p-0'>
            ...
            <table className='w-full'>
                <thead class=" table-header-group w-full">
                    <tr className=' w-full'>
                        <th class="report-header-cell w-full" colspan="7">
                            ...
                            <div className=' flex font-normal text-left pb-1'>
                ...
                <tbody className=' print:text-[11px]'>
                    ...
                    <tr className=' text-gray-900 print:text-[11px]'>
                        <td className=' font-semibold print:px-0 py-1 border-y border-gray-700 p-2'>Date</td>
                        <td className=' font-semibold print:px-0 py-1 border-y border-gray-700 p-2'>Cheque No</td>
                        <td className=' font-semibold print:px-0 py-1 border-y border-gray-700 p-2'>Narration</td>
                        <td className=' font-semibold print:px-0 py-1 border-y border-gray-700 p-2'>Trans Type</td>
                        <td className=' font-semibold print:px-0 py-1 border-y border-gray-700 p-2 text-right w-[15%]'>Debit</td>
                        <td className=' font-semibold print:px-0 py-1 border-y border-gray-700 p-2 text-right w-[15%]'>Credit</td>
                        <td className=' font-semibold print:px-0 py-1 border-y border-gray-700 p-2 text-right w-[15%]'>Balance</td>
                    </tr>

                    <tr className=''>
                        <td className='print:px-1 py-0 p-2 font-semibold'>Opening Balance</td>
                        <td className='print:px-1 py-0 p-2'></td>
                        <td className='print:px-1 py-0 p-2'></td>
                        <td className='print:px-1 py-0 p-2 text-right'></td>
                        <td className='print:px-1 py-0 p-2 text-right'></td>
                        <td className='print:px-1 py-0 p-2 text-right'></td>
                        <td className='print:px-1 py-0 p-2 text-right font-semibold'>{commaNumber(initialBalance)}</td>
                    </tr>
                        ...
                        randomTransictions.length > 0 && randomTransictions.map((item, index) => {
                            ...
                            return (
                                <tr className=' print:leading-[14px] align-text-top'>
                                    <td className='p-2 print:py-[2px] print:px-1'>
                                        {
                                            editMode ?
                                    ...
                                    <td className='p-2 print:py-[2px] print:px-[6px]'>
                                    ...
                                    <td className='p-2 print:py-[2px] print:px-1'>T</td>

                                    <td className='p-2 print:py-[2px] print:px-1 text-right'>{item.withdrawal > 0 && commaNumber(item.withdrawal)}</td>
                                    <td className='p-2 print:py-[2px] print:px-1 text-right'>{item.deposit > 0 && commaNumber(item.deposit)}</td>
                                    <td className='p-2 print:py-[2px] print:px-1 text-right'>{commaNumber(item.balance)}</td>
                                </tr>
                            )
                        })
                    }
            ...
            <div className=' print:fixed bottom-0 w-full print:text-[12px]'>
                ...
                <div className=' pt-3'>
                    <p className=' text-center print:text-[11px]'>The report is effective from {
                        editMode ?
                            <input type="text" value={statementValidDate} onChange={(e) => setStatementValidDate(e.target.value)} placeholder='Date' className=' rounded p-1 my-[2px] border border-blue-500 focus:outline-none w-full' />
                            :
                            <span>{statementValidDate}</span>
                    }</p>
                    <hr className=' bg-gray-700 w-full' />
                    <div className=' w-full flex justify-between print:text-[10px]'>
                        <p>Fast Path:-9820</p>
                        <p>Page 1 of 1</p>
                    </div>
                </div>
