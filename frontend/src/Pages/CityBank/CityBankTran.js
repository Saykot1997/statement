...
import AddTransactionCityBank from '../../Components/AddTransactionCityBank';
...
function CityBankTran() {
    ...
    return (
        <div className='w-full h-[calc(100vh-64px)] bg-gray-100 overflow-y-scroll p-5'>
                            ...
                            <div className=' bg-white px-5 py-3 rounded shadow flex justify-between' key={transaction._id}>
                                {
                                    updateModeOpen && currentTransactionId === transaction._id ?
                                        ...
                                        <div>
                                            ...
                                            <p className=' mt-2 text-sm'> <span className=' font-medium'>Chq.No. :</span> {transaction.cheque}</p>
            ...
            {
                addTransactionMode &&
                <AddTransactionCityBank toggleAddTransactionMode={toggleAddTransactionMode} />
            }
