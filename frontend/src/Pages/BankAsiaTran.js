...
import AddTransactionAB from '../Components/AddTransactionAB';
...
function BankAsiaTran() {
    ...
    return (
        <div className='w-full h-[calc(100vh-64px)] bg-gray-100 overflow-y-scroll p-5'>
            ...
            {
                addTransactionMode &&
                <AddTransactionAB toggleAddTransactionMode={toggleAddTransactionMode} />
            }
